...
async function fetchPosts() {
    ...
    try {
        const path = 'CMS/posts.json'; // Can be configurable if needed
...
function openEditor(postId = null) {
    ...
    if (postId) {
        ...
        if (post) {
            ...
            // document.getElementById('post-image').value = post.image || ''; // Removed by request
...
function handlePostSave(e) {
    ...
    const newPost = {
        ...
        // image: document.getElementById('post-image').value, // Removed by request
